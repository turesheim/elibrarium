 ...
 * $Id$
 */
package no.resheim.reader.library.util;

import no.resheim.reader.library.*;
 ...
 * <!-- end-user-doc -->
 * @see no.resheim.reader.library.LibraryPackage
 * @generated
 */
public class LibraryAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.resheim.reader.library.Library <em>Library</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.resheim.reader.library.Book <em>Book</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
