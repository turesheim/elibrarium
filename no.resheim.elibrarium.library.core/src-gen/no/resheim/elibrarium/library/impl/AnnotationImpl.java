...
public class AnnotationImpl extends BookmarkImpl implements Annotation {
	 ...
	 * @ordered
	 */
	protected static final AnnotationColor COLOR_EDEFAULT = AnnotationColor.YELLOW;
	...
	public void setColor(AnnotationColor newColor) {
		AnnotationColor oldColor = color;
		color = newColor == null ? COLOR_EDEFAULT : newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.ANNOTATION__COLOR, oldColor, color));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.ANNOTATION__COMMENT, oldComment, comment));
	}
