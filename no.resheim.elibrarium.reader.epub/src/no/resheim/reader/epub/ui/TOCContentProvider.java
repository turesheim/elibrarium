...
/**
 * Provides EPUB table of contents as tree content for use in i a {@link TreeViewer}.
 * 
...
public class TOCContentProvider implements ITreeContentProvider {
	...
	public Object[] getElements(Object inputElement) {
		if (inputElement instanceof OPS2Publication) {
			Object toc = ((OPSPublication) inputElement).getTableOfContents();
